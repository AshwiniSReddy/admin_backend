...
const corsOptionsDelegate = function (req, callback) {
    var corsOptions;
    let allowedOrigins = ['http://localhost:3000','https://paramscience.org','https://admindashboard.paramscience.org','http://dashboardadmin.s3-website.ap-south-1.amazonaws.com']; // You can add more origins as needed
